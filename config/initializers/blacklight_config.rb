...
#      "subject_era_facet"
    ...
    :labels => {
      ...
      "agent_name_facet"   => "Agent",
      "culturalContext_facet"   => "Cultural Context",
      "date_display_facet" => "Date",
      "stylePeriod_facet"  => "Style/Period",
      "subject_term_facet"   => "Subject",
      "technique_facet" => "Technique",
	  "worktype_facet"   => "Work Type",
 ...
 #     "subject_geo_facet"   => "Region"
    ...
    :limits => {
      "agent_name_facet" => 5,
      "culturalContext_facet" => 5,
      "date_display_facet" => 5,
      "stylePeriod_facet" => 5,
      "subject_term_facet" => 5,
      "worktype_facet" => 5,
      "language_facet" => true
    }
  }
