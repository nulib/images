...
$(function() {
  $('#addTitle').on("click", (function() {
    ...
    $('#addCulturalContext').on("click", (function() {
    ...
    $('#addStylePeriod').on("click", (function() {
  ...
  addField("material");
    ...
    $('#addMeasurements').on("click", (function() {
  ...
  addField("technique");
    ...
    $('input[id^="multiresimage_delete_agentSet_display_"]').on("click", (function() {
  deleteField($(this), "agent");
    }));

    $('input[id^="multiresimage_delete_titleSet_display_"]').on("click", (function() {
  deleteField($(this), "title");
    }));

    $('input[id^="multiresimage_delete_descriptionSet_display_"]').on("click", (function() {
  deleteField($(this), "description");
    }));

    $('input[id^="multiresimage_delete_dateSet_display_"]').on("click", (function() {
  deleteField($(this), "date");
    }));

    $('input[id^="multiresimage_delete_subjectSet_display_"]').on("click", (function() {
  deleteField($(this), "subject");
    }));

    $('input[id^="multiresimage_delete_locationSet_display_"]').on("click", (function() {
  deleteField($(this), "location");
    }));

    $('input[id^="multiresimage_delete_stylePeriodSet_display_"]').on("click", (function() {
  deleteField($(this), "stylePeriod");
    }));

    $('input[id^="multiresimage_delete_worktypeSet_display_"]').on("click", (function() {
  deleteField($(this), "worktype");
    }));

    $('input[id^="multiresimage_delete_inscriptionSet_display_"]').on("click", (function() {
  deleteField($(this), "inscription");
    }));

    $('input[id^="multiresimage_delete_culturalContextSet_display_"]').on("click", (function() {
  deleteField($(this), "culturalContext");
    }));

    $('input[id^="multiresimage_delete_materialSet_display_"]').on("click", (function() {
  deleteField($(this), "material");
    }));

    $('input[id^="multiresimage_delete_measurementsSet_display_"]').on("click", (function() {
  deleteField($(this), "measurements");
    }));

    $('input[id^="multiresimage_delete_sourceSet_display_"]').on("click", (function() {
  deleteField($(this), "source");
    }));

    $('input[id^="multiresimage_delete_techniqueSet_display_"]').on("click", (function() {
...
$('input[id^="batch_select_"]').on("click", (function() {
...
$("#submitCollectionBtn").on("click", (function() {
  ...
  $("#addToImageGroupBtn").on("click",(function() {
    $("#submitCollectionDiv").removeClass("hidden");
