...
<xsl:template name="marc2vra">
	...
	<xsl:if test="marc:datafield[@tag='100'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='c' or marc:subfield/@code='d' or marc:subfield/@code='g' or marc:subfield/@code='j' or marc:subfield/@code='q']
			or marc:datafield[@tag='110'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='g'] 
			or marc:datafield[@tag='700'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='c' or marc:subfield/@code='d' or marc:subfield/@code='g' or marc:subfield/@code='j' or marc:subfield/@code='q']
			or marc:datafield[@tag='710'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='g']"> 
		<xsl:call-template name="comment"><xsl:with-param name="comment">Agents</xsl:with-param></xsl:call-template>
		<vra:agentSet>
			<vra:display>
			<xsl:for-each select="marc:datafield[@tag='100'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='c' or marc:subfield/@code='d' or marc:subfield/@code='g' or marc:subfield/@code='j' or marc:subfield/@code='q']
			| marc:datafield[@tag='110'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='g'] 
			| marc:datafield[@tag='700'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='c' or marc:subfield/@code='d' or marc:subfield/@code='g' or marc:subfield/@code='j' or marc:subfield/@code='q']
			...
			<xsl:apply-templates select="marc:datafield[@tag='100'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='c' or marc:subfield/@code='d' or marc:subfield/@code='g' or marc:subfield/@code='j' or marc:subfield/@code='q']"/>
			<xsl:apply-templates select="marc:datafield[@tag='110'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='g']"/> 
			<xsl:apply-templates select="marc:datafield[@tag='700'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='c' or marc:subfield/@code='d' or marc:subfield/@code='g' or marc:subfield/@code='j' or marc:subfield/@code='q']"/>
			<xsl:apply-templates select="marc:datafield[@tag='710'][marc:subfield/@code='a' or marc:subfield/@code='b' or marc:subfield/@code='g']"/>
		</vra:agentSet>
	</xsl:if>
...
<!--	<xsl:if test="marc:datafield[@tag='752']/marc:subfield[not(@code='g')] | marc:datafield[@tag='535']/marc:subfield[@code='a' or @code='b' ] "> -->
	...
	<xsl:if test="marc:datafield[@tag='773']/marc:subfield[@code='a' or @code='g']">
...
<xsl:template match="marc:datafield[@tag='100'or @tag='700']">
	<vra:agent>
		<vra:name type="personal" vocab="ulan" refid="nnnnn"><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="marc:subfield[@code='a' or @code='b' or @code='c' or @code='g' or @code='j' or @code='q']"/></xsl:with-param></xsl:call-template></vra:name>
		<xsl:apply-templates select="marc:subfield[@code='d']" mode="agent"/>
	</vra:agent>
</xsl:template>
<xsl:template match="marc:datafield[@tag='110' or @tag='710']">
	<vra:agent>
		<vra:name type="corporate" vocab="ulan" refid="nnnnn"><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="marc:subfield[@code='a' or @code='b' or @code='g']"/></xsl:with-param></xsl:call-template></vra:name>
	</vra:agent>
</xsl:template>
...
<xsl:variable name="earliestDate"><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val">
		<!--xsl:value-of select="."/-->
		<xsl:value-of select="translate(., translate(.,'0123456789', ''), '')"></xsl:value-of>
		</xsl:with-param></xsl:call-template></xsl:variable>
	<xsl:if test="$earliestDate != ''">
	<vra:date type="creation">
		<vra:earliestDate><xsl:value-of select="$earliestDate"/></vra:earliestDate>
	</vra:date>
	</xsl:if>
</xsl:template>
<xsl:template match="marc:datafield[@tag='650' or @tag='651']/marc:subfield[@code='y']">
	<vra:date type="view">
		<xsl:choose>
		<xsl:when test="contains(.,'-')">
			<!--xsl:variable name="uno"><xsl:value-of select="substring-before(.,'-')"/></xsl:variable-->
			<xsl:variable name="uno"><xsl:value-of select="translate(substring-before(.,'-'),translate(.,'0123456789', ''), '')"/></xsl:variable>
			<!--xsl:variable name="dos"><xsl:value-of select="substring-after(.,'-')"/></xsl:variable-->
			<xsl:variable name="dos"><xsl:value-of select="translate(substring-after(.,'-'),translate(.,'0123456789', ''), '')"/></xsl:variable>
			<xsl:if test="$uno!=''"><vra:earliestDate><xsl:value-of select="$uno"/></vra:earliestDate></xsl:if>
			<xsl:choose><xsl:when test="$dos!=''"><vra:latestDate><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="$dos"/></xsl:with-param></xsl:call-template></vra:latestDate></xsl:when><xsl:otherwise><vra:earliestDate><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="$uno"/></xsl:with-param></xsl:call-template></vra:earliestDate></xsl:otherwise></xsl:choose>
		</xsl:when>
		<!--Added by Karen-->
		<xsl:when test="contains(.,'century')">
			<xsl:variable name="century"><xsl:value-of select="translate(.,'abcdefghijiklmnopqrstuvwxyz ', '')"/></xsl:variable>
			<vra:earliestDate>
			<xsl:value-of select="normalize-space(string(number($century)-1))"/>00</vra:earliestDate>
			<vra:latestDate><xsl:value-of select="normalize-space(string(number($century)-1))"/>99</vra:latestDate>
		</xsl:when>
		<!--End of Karen's new code-->
		<xsl:otherwise>
			<vra:earliestDate><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><!--xsl:value-of select="."/-->
		<xsl:value-of select="translate(., translate(.,'0123456789', ''), '')"/></xsl:with-param></xsl:call-template></vra:earliestDate>
			<vra:latestDate><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><!--xsl:value-of select="."/-->
		<xsl:value-of select="translate(., translate(.,'0123456789', ''), '')"/></xsl:with-param></xsl:call-template></vra:latestDate>
		</xsl:otherwise>
		</xsl:choose>
	</vra:date>
</xsl:template>
...
<xsl:template match="marc:datafield[@tag='752'][marc:subfield/@code!='g']" mode="display"><xsl:value-of select="marc:subfield/@code!='g'"/></xsl:template>
...
<xsl:template match="marc:datafield[@tag='600']/marc:subfield[@code='a' or @code='b' or @code='c' or @code='d' or @code='q']">
		<vra:subject><vra:term type="personalName" refid="nnnnn"><xsl:apply-templates select="../marc:subfield[@code='2']"/><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="."/></xsl:with-param></xsl:call-template></vra:term></vra:subject>
</xsl:template>
<xsl:template match="marc:datafield[@tag='610']/marc:subfield[@code='a' or @code='g']">
		<vra:subject><vra:term type="corporateName" refid="nnnnn"><xsl:apply-templates select="../marc:subfield[@code='2']"/><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="."/></xsl:with-param></xsl:call-template></vra:term></vra:subject>
</xsl:template>
<xsl:template match="marc:datafield[@tag='650']/marc:subfield[@code='a']">
		<vra:subject><vra:term type="descriptiveTopic" refid="nnnnn"><xsl:apply-templates select="../marc:subfield[@code='2']"/><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="."/></xsl:with-param></xsl:call-template></vra:term></vra:subject>
</xsl:template>
<xsl:template match="marc:datafield[@tag='650']/marc:subfield[@code='d' or @code='v']">
		<vra:subject><vra:term type="otherTopic" refid="nnnnn"><xsl:apply-templates select="../marc:subfield[@code='2']"/><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="."/></xsl:with-param></xsl:call-template></vra:term></vra:subject>
</xsl:template>
<xsl:template match="marc:datafield[@tag='650']/marc:subfield[@code='x']">
		<vra:subject><vra:term type="conceptTopic" refid="nnnnn"><xsl:apply-templates select="../marc:subfield[@code='2']"/><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="."/></xsl:with-param></xsl:call-template></vra:term></vra:subject>
</xsl:template>
<xsl:template match="marc:datafield[@tag='651']/marc:subfield[@code='a']">
		<vra:subject><vra:term type="geographicPlace" refid="nnnnn"><xsl:apply-templates select="../marc:subfield[@code='2']"/><xsl:call-template name="stripTrailingPeriod"><xsl:with-param name="val"><xsl:value-of select="."/></xsl:with-param></xsl:call-template></vra:term></vra:subject>
</xsl:template>
