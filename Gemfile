source 'http://rubygems.org'
  ...
  gem 'hydra-head', :git=>'git://github.com/projecthydra/hydra-head.git' , :ref=>'dca91b9'
  gem 'active-fedora', :git=>'git://github.com/projecthydra/active_fedora.git', :ref=>'42e66b7'# > 4.0.0.rc20 
  gem 'sqlite3'
